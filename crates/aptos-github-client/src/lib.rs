...
mod tests {
    ...
    fn test_files() {
        let path = "data.txt";
        let value1 = "hello";
        let value1_encoded = STANDARD.encode(value1);
        let value2 = "world";
        let value2_encoded = STANDARD.encode(value2);
        ...
        let b64_value = STANDARD.decode(github.get_file(path).unwrap()).unwrap();
    ...
    fn test_directories() {
        ...
        // Verify the contents
        let b64_value = STANDARD.decode(github.get_file(path1).unwrap()).unwrap();
        let value = std::str::from_utf8(&b64_value).unwrap();
        assert_eq!(value, value1);

        let b64_value = STANDARD.decode(github.get_file(path2).unwrap()).unwrap();
        let value = std::str::from_utf8(&b64_value).unwrap();
        assert_eq!(value, value2);
    ...
    fn test_recursive_delete_file() {
        ...
        let value = "hello";
        let value_encoded = STANDARD.encode(value);
        ...
        let b64_value = STANDARD.decode(github.get_file(file0).unwrap()).unwrap();
        let rv = std::str::from_utf8(&b64_value).unwrap();
        assert_eq!(value, rv);

        let b64_value = STANDARD.decode(github.get_file(file1).unwrap()).unwrap();
        let rv = std::str::from_utf8(&b64_value).unwrap();
        assert_eq!(value, rv);
