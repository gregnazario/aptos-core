...
Currently-supported BN254 structures include <code>[bn254_algebra.md#0x1_bn254_algebra_Fq12](Fq12)</code>, <code>[bn254_algebra.md#0x1_bn254_algebra_Fr](Fr)</code>, <code>[bn254_algebra.md#0x1_bn254_algebra_Fq](Fq)</code>, <code>Fq2</code>, <code>[bn254_algebra.md#0x1_bn254_algebra_G1](G1)</code>, <code>[bn254_algebra.md#0x1_bn254_algebra_G2](G2)</code> and <code>[bn254_algebra.md#0x1_bn254_algebra_Gt](Gt)</code>,
along with their widely-used serialization formats,
the pairing between <code>[bn254_algebra.md#0x1_bn254_algebra_G1](G1)</code>, <code>[bn254_algebra.md#0x1_bn254_algebra_G2](G2)</code> and <code>[bn254_algebra.md#0x1_bn254_algebra_Gt](Gt)</code>.
...
which is an extension field of <code>[bn254_algebra.md#0x1_bn254_algebra_Fq](Fq)</code>, constructed as $F_{q^2}=F_{q}[u]/(u^2+1)$.
...
<pre><code><b>struct</b> [bn254_algebra.md#0x1_bn254_algebra_Fr](Fr)
</code></pre>
...
A serialization format for <code>[bn254_algebra.md#0x1_bn254_algebra_Fr](Fr)</code> elements,
...
<pre><code><b>struct</b> [bn254_algebra.md#0x1_bn254_algebra_FormatFrLsb](FormatFrLsb)
</code></pre>
...
A serialization scheme for <code>[bn254_algebra.md#0x1_bn254_algebra_Fr](Fr)</code> elements,
where an element is represented by a byte array <code>b[]</code> of size 32 with the most significant byte (MSB) coming first.

NOTE: other implementation(s) using this format: ark-bn254-0.4.0.


<pre><code><b>struct</b> [bn254_algebra.md#0x1_bn254_algebra_FormatFrMsb](FormatFrMsb)
</code></pre>
...
<pre><code><b>struct</b> [bn254_algebra.md#0x1_bn254_algebra_Fq](Fq)
</code></pre>
...
A serialization format for <code>[bn254_algebra.md#0x1_bn254_algebra_Fq](Fq)</code> elements,
where an element is represented by a byte array <code>b[]</code> of size 32 with the least significant byte (LSB) coming first.

NOTE: other implementation(s) using this format: ark-bn254-0.4.0.


<pre><code><b>struct</b> [bn254_algebra.md#0x1_bn254_algebra_FormatFqLsb](FormatFqLsb)
</code></pre>
...
A serialization scheme for <code>[bn254_algebra.md#0x1_bn254_algebra_Fq](Fq)</code> elements,
where an element is represented by a byte array <code>b[]</code> of size 32 with the most significant byte (MSB) coming first.

NOTE: other implementation(s) using this format: ark-bn254-0.4.0.


<pre><code><b>struct</b> [bn254_algebra.md#0x1_bn254_algebra_FormatFqMsb](FormatFqMsb)
</code></pre>
...
The field can downcast to <code>[bn254_algebra.md#0x1_bn254_algebra_Gt](Gt)</code> if it's an element of the multiplicative subgroup <code>[bn254_algebra.md#0x1_bn254_algebra_Gt](Gt)</code> of <code>[bn254_algebra.md#0x1_bn254_algebra_Fq12](Fq12)</code>
with a prime order $r$ = 0x73eda753299d7d483339d80809a1d80553bda402fffe5bfeffffffff00000001.


<pre><code><b>struct</b> [bn254_algebra.md#0x1_bn254_algebra_Fq12](Fq12)
</code></pre>
...
A serialization scheme for <code>[bn254_algebra.md#0x1_bn254_algebra_Fq12](Fq12)</code> elements,
...
<pre><code><b>struct</b> [bn254_algebra.md#0x1_bn254_algebra_FormatFq12LscLsb](FormatFq12LscLsb)
</code></pre>
...
(so <code>[bn254_algebra.md#0x1_bn254_algebra_Fr](Fr)</code> is the associated scalar field).


<pre><code><b>struct</b> [bn254_algebra.md#0x1_bn254_algebra_G1](G1)
</code></pre>
...
A serialization scheme for <code>[bn254_algebra.md#0x1_bn254_algebra_G1](G1)</code> elements derived from arkworks.rs.

Below is the serialization procedure that takes a <code>[bn254_algebra.md#0x1_bn254_algebra_G1](G1)</code> element <code>p</code> and outputs a byte array of size N=64.
1. Let <code>(x,y)</code> be the coordinates of <code>p</code> if <code>p</code> is on the curve, or <code>(0,0)</code> otherwise.
1. Serialize <code>x</code> and <code>y</code> into <code>b_x[]</code> and <code>b_y[]</code> respectively using <code>[bn254_algebra.md#0x1_bn254_algebra_FormatFqLsb](FormatFqLsb)</code> (defined in the module documentation).
...
Below is the deserialization procedure that takes a byte array <code>b[]</code> and outputs either a <code>[bn254_algebra.md#0x1_bn254_algebra_G1](G1)</code> element or none.
...
1. Deserialize <code>[b[0], b[1], ..., b[N/2-1]]</code> to <code>x</code> using <code>[bn254_algebra.md#0x1_bn254_algebra_FormatFqLsb](FormatFqLsb)</code>. If <code>x</code> is none, return none.
1. Deserialize <code>[b[N/2], ..., b[N] & 0b0011_1111]</code> to <code>y</code> using <code>[bn254_algebra.md#0x1_bn254_algebra_FormatFqLsb](FormatFqLsb)</code>. If <code>y</code> is none, return none.
...
<pre><code><b>struct</b> [bn254_algebra.md#0x1_bn254_algebra_FormatG1Uncompr](FormatG1Uncompr)
</code></pre>
...
Below is the serialization procedure that takes a <code>[bn254_algebra.md#0x1_bn254_algebra_G1](G1)</code> element <code>p</code> and outputs a byte array of size N=32.
1. Let <code>(x,y)</code> be the coordinates of <code>p</code> if <code>p</code> is on the curve, or <code>(0,0)</code> otherwise.
1. Serialize <code>x</code> into <code>b[]</code> using <code>[bn254_algebra.md#0x1_bn254_algebra_FormatFqLsb](FormatFqLsb)</code> (defined in the module documentation).
1. If <code>p</code> is the point at infinity, set the infinity bit: <code>b[N-1]: = b[N-1] | 0b0100_0000</code>.
...
1. Deserialize <code>[b[0], b[1], ..., b[N/2-1] & 0b0011_1111]</code> to <code>x</code> using <code>[bn254_algebra.md#0x1_bn254_algebra_FormatFqLsb](FormatFqLsb)</code>. If <code>x</code> is none, return none.
...
<pre><code><b>struct</b> [bn254_algebra.md#0x1_bn254_algebra_FormatG1Compr](FormatG1Compr)
</code></pre>
...
(so <code>[bn254_algebra.md#0x1_bn254_algebra_Fr](Fr)</code> is the scalar field).


<pre><code><b>struct</b> [bn254_algebra.md#0x1_bn254_algebra_G2](G2)
</code></pre>
...
A serialization scheme for <code>[bn254_algebra.md#0x1_bn254_algebra_G2](G2)</code> elements derived from arkworks.rs.

Below is the serialization procedure that takes a <code>[bn254_algebra.md#0x1_bn254_algebra_G2](G2)</code> element <code>p</code> and outputs a byte array of size N=128.
1. Let <code>(x,y)</code> be the coordinates of <code>p</code> if <code>p</code> is on the curve, or <code>(0,0)</code> otherwise.
...
<pre><code><b>struct</b> [bn254_algebra.md#0x1_bn254_algebra_FormatG2Uncompr](FormatG2Uncompr)
</code></pre>
...
<pre><code><b>struct</b> [bn254_algebra.md#0x1_bn254_algebra_FormatG2Compr](FormatG2Compr)
</code></pre>
...
It is a multiplicative subgroup of <code>[bn254_algebra.md#0x1_bn254_algebra_Fq12](Fq12)</code>, so it  can upcast to <code>[bn254_algebra.md#0x1_bn254_algebra_Fq12](Fq12)</code>.
with a prime order $r$ equal to 0x73eda753299d7d483339d80809a1d80553bda402fffe5bfeffffffff00000001.
(so <code>[bn254_algebra.md#0x1_bn254_algebra_Fr](Fr)</code> is the scalar field).
The identity of <code>[bn254_algebra.md#0x1_bn254_algebra_Gt](Gt)</code> is 1.


<pre><code><b>struct</b> [bn254_algebra.md#0x1_bn254_algebra_Gt](Gt)
</code></pre>
...
A serialization scheme for <code>[bn254_algebra.md#0x1_bn254_algebra_Gt](Gt)</code> elements.

To serialize, it treats a <code>[bn254_algebra.md#0x1_bn254_algebra_Gt](Gt)</code> element <code>p</code> as an <code>[bn254_algebra.md#0x1_bn254_algebra_Fq12](Fq12)</code> element and serialize it using <code>[bn254_algebra.md#0x1_bn254_algebra_FormatFq12LscLsb](FormatFq12LscLsb)</code>.

To deserialize, it uses <code>[bn254_algebra.md#0x1_bn254_algebra_FormatFq12LscLsb](FormatFq12LscLsb)</code> to try deserializing to an <code>[bn254_algebra.md#0x1_bn254_algebra_Fq12](Fq12)</code> element then test the membership in <code>[bn254_algebra.md#0x1_bn254_algebra_Gt](Gt)</code>.

NOTE: other implementation(s) using this format: ark-bn254-0.4.0.


<pre><code><b>struct</b> [bn254_algebra.md#0x1_bn254_algebra_FormatGt](FormatGt)
</code></pre>
