...
Currently-supported BLS12-381 structures include <code>[bls12381_algebra.md#0x1_bls12381_algebra_Fq12](Fq12)</code>, <code>[bls12381_algebra.md#0x1_bls12381_algebra_Fr](Fr)</code>, <code>[bls12381_algebra.md#0x1_bls12381_algebra_G1](G1)</code>, <code>[bls12381_algebra.md#0x1_bls12381_algebra_G2](G2)</code> and <code>[bls12381_algebra.md#0x1_bls12381_algebra_Gt](Gt)</code>,
along with their widely-used serialization formats,
the pairing between <code>[bls12381_algebra.md#0x1_bls12381_algebra_G1](G1)</code>, <code>[bls12381_algebra.md#0x1_bls12381_algebra_G2](G2)</code> and <code>[bls12381_algebra.md#0x1_bls12381_algebra_Gt](Gt)</code>,
and the hash-to-curve operations for <code>[bls12381_algebra.md#0x1_bls12381_algebra_G1](G1)</code> and <code>[bls12381_algebra.md#0x1_bls12381_algebra_G2](G2)</code> defined in https://datatracker.ietf.org/doc/html/draft-irtf-cfrg-hash-to-curve-16.
...
<pre><code><b>struct</b> [bls12381_algebra.md#0x1_bls12381_algebra_Fq12](Fq12)
</code></pre>
...
A serialization scheme for <code>[bls12381_algebra.md#0x1_bls12381_algebra_Fq12](Fq12)</code> elements,
...
<pre><code><b>struct</b> [bls12381_algebra.md#0x1_bls12381_algebra_FormatFq12LscLsb](FormatFq12LscLsb)
</code></pre>
...
(so <code>[bls12381_algebra.md#0x1_bls12381_algebra_Fr](Fr)</code> is the associated scalar field).


<pre><code><b>struct</b> [bls12381_algebra.md#0x1_bls12381_algebra_G1](G1)
</code></pre>
...
A serialization scheme for <code>[bls12381_algebra.md#0x1_bls12381_algebra_G1](G1)</code> elements derived from
https://www.ietf.org/archive/id/draft-irtf-cfrg-pairing-friendly-curves-11.html#name-zcash-serialization-format-.

Below is the serialization procedure that takes a <code>[bls12381_algebra.md#0x1_bls12381_algebra_G1](G1)</code> element <code>p</code> and outputs a byte array of size 96.
...
Below is the deserialization procedure that takes a byte array <code>b[]</code> and outputs either a <code>[bls12381_algebra.md#0x1_bls12381_algebra_G1](G1)</code> element or none.
...
<pre><code><b>struct</b> [bls12381_algebra.md#0x1_bls12381_algebra_FormatG1Uncompr](FormatG1Uncompr)
</code></pre>
...
Below is the serialization procedure that takes a <code>[bls12381_algebra.md#0x1_bls12381_algebra_G1](G1)</code> element <code>p</code> and outputs a byte array of size 48.
1. Let <code>(x,y)</code> be the coordinates of <code>p</code> if <code>p</code> is on the curve, or <code>(0,0)</code> otherwise.
...
<pre><code><b>struct</b> [bls12381_algebra.md#0x1_bls12381_algebra_FormatG1Compr](FormatG1Compr)
</code></pre>
...
(so <code>[bls12381_algebra.md#0x1_bls12381_algebra_Fr](Fr)</code> is the scalar field).


<pre><code><b>struct</b> [bls12381_algebra.md#0x1_bls12381_algebra_G2](G2)
</code></pre>
...
A serialization scheme for <code>[bls12381_algebra.md#0x1_bls12381_algebra_G2](G2)</code> elements derived from
https://www.ietf.org/archive/id/draft-irtf-cfrg-pairing-friendly-curves-11.html#name-zcash-serialization-format-.

Below is the serialization procedure that takes a <code>[bls12381_algebra.md#0x1_bls12381_algebra_G2](G2)</code> element <code>p</code> and outputs a byte array of size 192.
1. Let <code>(x,y)</code> be the coordinates of <code>p</code> if <code>p</code> is on the curve, or <code>(0,0)</code> otherwise.
...
Below is the deserialization procedure that takes a byte array <code>b[]</code> and outputs either a <code>[bls12381_algebra.md#0x1_bls12381_algebra_G2](G2)</code> element or none.
...
<pre><code><b>struct</b> [bls12381_algebra.md#0x1_bls12381_algebra_FormatG2Uncompr](FormatG2Uncompr)
</code></pre>
...
Below is the serialization procedure that takes a <code>[bls12381_algebra.md#0x1_bls12381_algebra_G2](G2)</code> element <code>p</code> and outputs a byte array of size 96.
1. Let <code>(x,y)</code> be the coordinates of <code>p</code> if <code>p</code> is on the curve, or <code>(0,0)</code> otherwise.
...
<pre><code><b>struct</b> [bls12381_algebra.md#0x1_bls12381_algebra_FormatG2Compr](FormatG2Compr)
</code></pre>
...
It is a multiplicative subgroup of <code>[bls12381_algebra.md#0x1_bls12381_algebra_Fq12](Fq12)</code>,
with a prime order $r$ equal to 0x73eda753299d7d483339d80809a1d80553bda402fffe5bfeffffffff00000001.
(so <code>[bls12381_algebra.md#0x1_bls12381_algebra_Fr](Fr)</code> is the scalar field).
The identity of <code>[bls12381_algebra.md#0x1_bls12381_algebra_Gt](Gt)</code> is 1.


<pre><code><b>struct</b> [bls12381_algebra.md#0x1_bls12381_algebra_Gt](Gt)
</code></pre>
...
A serialization scheme for <code>[bls12381_algebra.md#0x1_bls12381_algebra_Gt](Gt)</code> elements.

To serialize, it treats a <code>[bls12381_algebra.md#0x1_bls12381_algebra_Gt](Gt)</code> element <code>p</code> as an <code>[bls12381_algebra.md#0x1_bls12381_algebra_Fq12](Fq12)</code> element and serialize it using <code>[bls12381_algebra.md#0x1_bls12381_algebra_FormatFq12LscLsb](FormatFq12LscLsb)</code>.

To deserialize, it uses <code>[bls12381_algebra.md#0x1_bls12381_algebra_FormatFq12LscLsb](FormatFq12LscLsb)</code> to try deserializing to an <code>[bls12381_algebra.md#0x1_bls12381_algebra_Fq12](Fq12)</code> element then test the membership in <code>[bls12381_algebra.md#0x1_bls12381_algebra_Gt](Gt)</code>.

NOTE: other implementation(s) using this format: ark-bls12-381-0.4.0.


<pre><code><b>struct</b> [bls12381_algebra.md#0x1_bls12381_algebra_FormatGt](FormatGt)
</code></pre>
...
<pre><code><b>struct</b> [bls12381_algebra.md#0x1_bls12381_algebra_Fr](Fr)
</code></pre>
...
A serialization format for <code>[bls12381_algebra.md#0x1_bls12381_algebra_Fr](Fr)</code> elements,
...
<pre><code><b>struct</b> [bls12381_algebra.md#0x1_bls12381_algebra_FormatFrLsb](FormatFrLsb)
</code></pre>
...
A serialization scheme for <code>[bls12381_algebra.md#0x1_bls12381_algebra_Fr](Fr)</code> elements,
where an element is represented by a byte array <code>b[]</code> of size 32 with the most significant byte (MSB) coming first.

NOTE: other implementation(s) using this format: ark-bls12-381-0.4.0, blst-0.3.7.


<pre><code><b>struct</b> [bls12381_algebra.md#0x1_bls12381_algebra_FormatFrMsb](FormatFrMsb)
</code></pre>
...
The hash-to-curve suite <code>BLS12381G1_XMD:SHA-256_SSWU_RO_</code> that hashes a byte array into <code>[bls12381_algebra.md#0x1_bls12381_algebra_G1](G1)</code> elements.

Full specification is defined in https://datatracker.ietf.org/doc/html/draft-irtf-cfrg-hash-to-curve-16#name-bls12-381-g1.


<pre><code><b>struct</b> [bls12381_algebra.md#0x1_bls12381_algebra_HashG1XmdSha256SswuRo](HashG1XmdSha256SswuRo)
</code></pre>
...
The hash-to-curve suite <code>BLS12381G2_XMD:SHA-256_SSWU_RO_</code> that hashes a byte array into <code>[bls12381_algebra.md#0x1_bls12381_algebra_G2](G2)</code> elements.

Full specification is defined in https://datatracker.ietf.org/doc/html/draft-irtf-cfrg-hash-to-curve-16#name-bls12-381-g2.


<pre><code><b>struct</b> [bls12381_algebra.md#0x1_bls12381_algebra_HashG2XmdSha256SswuRo](HashG2XmdSha256SswuRo)
</code></pre>
