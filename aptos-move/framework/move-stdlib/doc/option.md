...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_none](none)&lt;Element&gt;(): [option.md#0x1_option_Option](Option)&lt;Element&gt; {
    [option.md#0x1_option_Option](Option) { vec: [vector.md#0x1_vector_empty](vector::empty)() }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_some](some)&lt;Element&gt;(e: Element): [option.md#0x1_option_Option](Option)&lt;Element&gt; {
    [option.md#0x1_option_Option](Option) { vec: [vector.md#0x1_vector_singleton](vector::singleton)(e) }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_from_vec](from_vec)&lt;Element&gt;(vec: [vector.md#0x1_vector](vector)&lt;Element&gt;): [option.md#0x1_option_Option](Option)&lt;Element&gt; {
    <b>assert</b>!([vector.md#0x1_vector_length](vector::length)(&vec) &lt;= 1, [option.md#0x1_option_EOPTION_VEC_TOO_LONG](EOPTION_VEC_TOO_LONG));
    [option.md#0x1_option_Option](Option) { vec }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_is_none](is_none)&lt;Element&gt;(t: &[option.md#0x1_option_Option](Option)&lt;Element&gt;): bool {
...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_is_some](is_some)&lt;Element&gt;(t: &[option.md#0x1_option_Option](Option)&lt;Element&gt;): bool {
    ![vector.md#0x1_vector_is_empty](vector::is_empty)(&t.vec)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_contains](contains)&lt;Element&gt;(t: &[option.md#0x1_option_Option](Option)&lt;Element&gt;, e_ref: &Element): bool {
    [vector.md#0x1_vector_contains](vector::contains)(&t.vec, e_ref)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_borrow](borrow)&lt;Element&gt;(t: &[option.md#0x1_option_Option](Option)&lt;Element&gt;): &Element {
    <b>assert</b>!([option.md#0x1_option_is_some](is_some)(t), [option.md#0x1_option_EOPTION_NOT_SET](EOPTION_NOT_SET));
    [vector.md#0x1_vector_borrow](vector::borrow)(&t.vec, 0)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_borrow_with_default](borrow_with_default)&lt;Element&gt;(t: &[option.md#0x1_option_Option](Option)&lt;Element&gt;, default_ref: &Element): &Element {
    <b>let</b> vec_ref = &t.vec;
    <b>if</b> ([vector.md#0x1_vector_is_empty](vector::is_empty)(vec_ref)) default_ref
    <b>else</b> [vector.md#0x1_vector_borrow](vector::borrow)(vec_ref, 0)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_get_with_default](get_with_default)&lt;Element: <b>copy</b> + drop&gt;(
    t: &[option.md#0x1_option_Option](Option)&lt;Element&gt;,
    default: Element,
): Element {
    <b>let</b> vec_ref = &t.vec;
    <b>if</b> ([vector.md#0x1_vector_is_empty](vector::is_empty)(vec_ref)) default
    <b>else</b> *[vector.md#0x1_vector_borrow](vector::borrow)(vec_ref, 0)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_fill](fill)&lt;Element&gt;(t: &<b>mut</b> [option.md#0x1_option_Option](Option)&lt;Element&gt;, e: Element) {
    <b>let</b> vec_ref = &<b>mut</b> t.vec;
    <b>if</b> ([vector.md#0x1_vector_is_empty](vector::is_empty)(vec_ref)) [vector.md#0x1_vector_push_back](vector::push_back)(vec_ref, e)
    <b>else</b> <b>abort</b> [option.md#0x1_option_EOPTION_IS_SET](EOPTION_IS_SET)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_extract](extract)&lt;Element&gt;(t: &<b>mut</b> [option.md#0x1_option_Option](Option)&lt;Element&gt;): Element {
    <b>assert</b>!([option.md#0x1_option_is_some](is_some)(t), [option.md#0x1_option_EOPTION_NOT_SET](EOPTION_NOT_SET));
    [vector.md#0x1_vector_pop_back](vector::pop_back)(&<b>mut</b> t.vec)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_borrow_mut](borrow_mut)&lt;Element&gt;(t: &<b>mut</b> [option.md#0x1_option_Option](Option)&lt;Element&gt;): &<b>mut</b> Element {
    <b>assert</b>!([option.md#0x1_option_is_some](is_some)(t), [option.md#0x1_option_EOPTION_NOT_SET](EOPTION_NOT_SET));
    [vector.md#0x1_vector_borrow_mut](vector::borrow_mut)(&<b>mut</b> t.vec, 0)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_swap](swap)&lt;Element&gt;(t: &<b>mut</b> [option.md#0x1_option_Option](Option)&lt;Element&gt;, e: Element): Element {
    <b>assert</b>!([option.md#0x1_option_is_some](is_some)(t), [option.md#0x1_option_EOPTION_NOT_SET](EOPTION_NOT_SET));
    <b>let</b> vec_ref = &<b>mut</b> t.vec;
    <b>let</b> old_value = [vector.md#0x1_vector_pop_back](vector::pop_back)(vec_ref);
    [vector.md#0x1_vector_push_back](vector::push_back)(vec_ref, e);
    old_value
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_swap_or_fill](swap_or_fill)&lt;Element&gt;(t: &<b>mut</b> [option.md#0x1_option_Option](Option)&lt;Element&gt;, e: Element): [option.md#0x1_option_Option](Option)&lt;Element&gt; {
    <b>let</b> vec_ref = &<b>mut</b> t.vec;
    <b>let</b> old_value = <b>if</b> ([vector.md#0x1_vector_is_empty](vector::is_empty)(vec_ref)) [option.md#0x1_option_none](none)()
        <b>else</b> [option.md#0x1_option_some](some)([vector.md#0x1_vector_pop_back](vector::pop_back)(vec_ref));
    [vector.md#0x1_vector_push_back](vector::push_back)(vec_ref, e);
    old_value
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_destroy_with_default](destroy_with_default)&lt;Element: drop&gt;(t: [option.md#0x1_option_Option](Option)&lt;Element&gt;, default: Element): Element {
    <b>let</b> [option.md#0x1_option_Option](Option) { vec } = t;
    <b>if</b> ([vector.md#0x1_vector_is_empty](vector::is_empty)(&<b>mut</b> vec)) default
    <b>else</b> [vector.md#0x1_vector_pop_back](vector::pop_back)(&<b>mut</b> vec)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_destroy_some](destroy_some)&lt;Element&gt;(t: [option.md#0x1_option_Option](Option)&lt;Element&gt;): Element {
    <b>assert</b>!([option.md#0x1_option_is_some](is_some)(&t), [option.md#0x1_option_EOPTION_NOT_SET](EOPTION_NOT_SET));
    <b>let</b> [option.md#0x1_option_Option](Option) { vec } = t;
    <b>let</b> elem = [vector.md#0x1_vector_pop_back](vector::pop_back)(&<b>mut</b> vec);
    [vector.md#0x1_vector_destroy_empty](vector::destroy_empty)(vec);
    elem
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_destroy_none](destroy_none)&lt;Element&gt;(t: [option.md#0x1_option_Option](Option)&lt;Element&gt;) {
    <b>assert</b>!([option.md#0x1_option_is_none](is_none)(&t), [option.md#0x1_option_EOPTION_IS_SET](EOPTION_IS_SET));
    <b>let</b> [option.md#0x1_option_Option](Option) { vec } = t;
    [vector.md#0x1_vector_destroy_empty](vector::destroy_empty)(vec)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> [option.md#0x1_option_to_vec](to_vec)&lt;Element&gt;(t: [option.md#0x1_option_Option](Option)&lt;Element&gt;): [vector.md#0x1_vector](vector)&lt;Element&gt; {
    <b>let</b> [option.md#0x1_option_Option](Option) { vec } = t;
    vec
}
</code></pre>
...
<pre><code><b>public</b> inline <b>fun</b> [option.md#0x1_option_for_each](for_each)&lt;Element&gt;(o: [option.md#0x1_option_Option](Option)&lt;Element&gt;, f: |Element|) {
    <b>if</b> ([option.md#0x1_option_is_some](is_some)(&o)) {
        f([option.md#0x1_option_destroy_some](destroy_some)(o))
    } <b>else</b> {
        [option.md#0x1_option_destroy_none](destroy_none)(o)
    }
}
</code></pre>
...
<pre><code><b>public</b> inline <b>fun</b> [option.md#0x1_option_for_each_ref](for_each_ref)&lt;Element&gt;(o: &[option.md#0x1_option_Option](Option)&lt;Element&gt;, f: |&Element|) {
    <b>if</b> ([option.md#0x1_option_is_some](is_some)(o)) {
        f([option.md#0x1_option_borrow](borrow)(o))
    }
}
</code></pre>
...
<pre><code><b>public</b> inline <b>fun</b> [option.md#0x1_option_for_each_mut](for_each_mut)&lt;Element&gt;(o: &<b>mut</b> [option.md#0x1_option_Option](Option)&lt;Element&gt;, f: |&<b>mut</b> Element|) {
    <b>if</b> ([option.md#0x1_option_is_some](is_some)(o)) {
        f([option.md#0x1_option_borrow_mut](borrow_mut)(o))
    }
}
</code></pre>
...
<pre><code><b>public</b> inline <b>fun</b> [option.md#0x1_option_fold](fold)&lt;Accumulator, Element&gt;(
    o: [option.md#0x1_option_Option](Option)&lt;Element&gt;,
    init: Accumulator,
    f: |Accumulator,Element|Accumulator
): Accumulator {
    <b>if</b> ([option.md#0x1_option_is_some](is_some)(&o)) {
        f(init, [option.md#0x1_option_destroy_some](destroy_some)(o))
    } <b>else</b> {
        [option.md#0x1_option_destroy_none](destroy_none)(o);
        init
    }
...
<pre><code><b>public</b> inline <b>fun</b> [option.md#0x1_option_map](map)&lt;Element, OtherElement&gt;(o: [option.md#0x1_option_Option](Option)&lt;Element&gt;, f: |Element|OtherElement): [option.md#0x1_option_Option](Option)&lt;OtherElement&gt; {
    <b>if</b> ([option.md#0x1_option_is_some](is_some)(&o)) {
        [option.md#0x1_option_some](some)(f([option.md#0x1_option_destroy_some](destroy_some)(o)))
    } <b>else</b> {
        [option.md#0x1_option_destroy_none](destroy_none)(o);
        [option.md#0x1_option_none](none)()
    }
}
</code></pre>
...
<pre><code><b>public</b> inline <b>fun</b> [option.md#0x1_option_map_ref](map_ref)&lt;Element, OtherElement&gt;(
    o: &[option.md#0x1_option_Option](Option)&lt;Element&gt;, f: |&Element|OtherElement): [option.md#0x1_option_Option](Option)&lt;OtherElement&gt; {
    <b>if</b> ([option.md#0x1_option_is_some](is_some)(o)) {
        [option.md#0x1_option_some](some)(f([option.md#0x1_option_borrow](borrow)(o)))
    } <b>else</b> {
        [option.md#0x1_option_none](none)()
    }
}
...
<pre><code><b>public</b> inline <b>fun</b> [option.md#0x1_option_filter](filter)&lt;Element:drop&gt;(o: [option.md#0x1_option_Option](Option)&lt;Element&gt;, f: |&Element|bool): [option.md#0x1_option_Option](Option)&lt;Element&gt; {
    <b>if</b> ([option.md#0x1_option_is_some](is_some)(&o) && f([option.md#0x1_option_borrow](borrow)(&o))) {
        o
    } <b>else</b> {
        [option.md#0x1_option_none](none)()
    }
...
<pre><code><b>public</b> inline <b>fun</b> [option.md#0x1_option_any](any)&lt;Element&gt;(o: &[option.md#0x1_option_Option](Option)&lt;Element&gt;, p: |&Element|bool): bool {
    [option.md#0x1_option_is_some](is_some)(o) && p([option.md#0x1_option_borrow](borrow)(o))
}
</code></pre>
...
<pre><code><b>public</b> inline <b>fun</b> [option.md#0x1_option_destroy](destroy)&lt;Element&gt;(o: [option.md#0x1_option_Option](Option)&lt;Element&gt;, d: |Element|) {
    <b>let</b> vec = [option.md#0x1_option_to_vec](to_vec)(o);
    [vector.md#0x1_vector_destroy](vector::destroy)(vec, |e| d(e));
}
</code></pre>
