...
case "$OS" in
  Linux)
    if command -v apt-get &>/dev/null; then
      ...
      sh install_pkg.sh gcc make pkgconf openssl-devel git rust-libudev-devel lld elfutils-devel clang llvm cmake
      ...
      # OpenSUSE zypper
      sh install_pkg.sh gcc make pkg-config libopenssl-devel git libudev-devel lld libdw-devel clang llvm cmake
